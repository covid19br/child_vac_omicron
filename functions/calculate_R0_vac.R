...
calculate_R0 <- function(parameters){
  ...
  R0 <- with(parameters,{
    contact.u <- diag(Su)%*%(c%*%diag(1/N))
    contact.vA <- diag(SvA)%*%(c%*%diag(1/N))
    contact.vP <- diag(SvP)%*%(c%*%diag(1/N))
    contact.vC <- diag(SvC)%*%(c%*%diag(1/N))
    contact.wA <- diag(SwA)%*%(c%*%diag(1/N))
    contact.wP <- diag(SwP)%*%(c%*%diag(1/N))
    contact.wC <- diag(SwC)%*%(c%*%diag(1/N))

    ############################################################################
    ############################### DELTA ######################################
    ############################################################################    
    
    # X_0 = (Eu.D, EvA.D, EvP.D, EvC.D, EwA.D, EwP.D,EwC.D,
    #          Iu.D, IvA.D, IvP.D, IvC.D, IwA.D, IwP.D,IwC.D,
    #          Au.D, AvA.D, AvP.D, AvC.D, AwA.D, AwP.D,AwC.D,
    #          Hu.D, HvA.D, HvP.D, HvC.D, HwA.D, HwP.D,HwC.D)
    # X_1 = (Su, SvA, SvP, SvP, SvC, SwA, SwP, SwC,
    #        Ru.D, RvA.D, RvP.D, RvC.D, RwA.D, RwP.D, RwC.D,
    #        Du.D, DvA.D, DvP.D, DvC.D, DwA.D, DwP.D, DwC.D)
    
    ############################### F matrix ###################################
    # EuDxE cols
    F_Eu.DEu.D <- F_Eu.DEvA.D <- F_Eu.DEvP.D <- F_Eu.DEvC.D <- 
      F_Eu.DEwA.D <- F_Eu.DEwP.D <- F_Eu.DEwC.D <-  beta.D*omega*contact.u
    # EuDxA cols
    F_Eu.DAu.D <- F_Eu.DAvA.D <- F_Eu.DAvP.D <- F_Eu.DAvC.D <- 
      F_Eu.DAwA.D <- F_Eu.DAwP.D <- F_Eu.DAwC.D <- beta.D*omega_a*contact.u    
    # EuDxI cols
    F_Eu.DIu.D <- F_Eu.DIvA.D <- F_Eu.DIvP.D <- F_Eu.DIvC.D <- 
      F_Eu.DIwA.D <- F_Eu.DIwP.D <- F_Eu.DIwC.D <- beta.D*contact.u
    # EuDxH cols
    F_Eu.DHu.D <- F_Eu.DHvA.D <- F_Eu.DHvP.D <- F_Eu.DHvC.D <- 
      F_Eu.DHwA.D <- F_Eu.DHwP.D <- F_Eu.DHwC.D <- beta.D*omega_s*contact.u
    # EuD lines
    F_Eu.D <- cbind(F_Eu.DEu.D, F_Eu.DEvA.D, F_Eu.DEvP.D, F_Eu.DEvC.D, 
                                F_Eu.DEwA.D, F_Eu.DEwP.D, F_Eu.DEwC.D,
                    F_Eu.DAu.D, F_Eu.DAvA.D, F_Eu.DAvP.D, F_Eu.DAvC.D, 
                                F_Eu.DAwA.D, F_Eu.DAwP.D, F_Eu.DAwC.D, 
                    F_Eu.DIu.D, F_Eu.DIvA.D, F_Eu.DIvP.D, F_Eu.DIvC.D, 
                                F_Eu.DIwA.D, F_Eu.DIwP.D, F_Eu.DIwC.D, 
                    F_Eu.DHu.D, F_Eu.DHvA.D, F_Eu.DHvP.D, F_Eu.DHvC.D,
                                F_Eu.DHwA.D, F_Eu.DHwP.D, F_Eu.DHwC.D)
    
    # EvA.DxE cols
    F_EvA.DEu.D <- F_EvA.DEvA.D <- F_EvA.DEvP.D <- F_EvA.DEvC.D <- 
      F_EvA.DEwA.D <- F_EvA.DEwP.D <- F_EvA.DEwC.D <- beta_vA.D*omega*contact.vA
    #EvA.DxA cols    
    F_EvA.DAu.D <- F_EvA.DAvA.D <- F_EvA.DAvP.D <- F_EvA.DAvC.D <- 
      F_EvA.DAwA.D <- F_EvA.DAwP.D <- F_EvA.DAwC.D <- beta_vA.D*omega_a*contact.vA
    # EvA.DxI cols
    F_EvA.DIu.D <- F_EvA.DIvA.D <- F_EvA.DIvP.D <- F_EvA.DIvC.D <- 
      F_EvA.DIwA.D <- F_EvA.DIwP.D <- F_EvA.DIwC.D <- beta_vA.D*contact.vA
    #EvA.DxH cols
    F_EvA.DHu.D <- F_EvA.DHvA.D <- F_EvA.DHvP.D <- F_EvA.DHvC.D <- 
      F_EvA.DHwA.D <- F_EvA.DHwP.D <- F_EvA.DHwC.D <- beta_vA.D*omega_s*contact.vA
    #F_EvA.D lines
    F_EvA.D <- cbind(F_EvA.DEu.D, F_EvA.DEvA.D, F_EvA.DEvP.D, F_EvA.DEvC.D, 
                                  F_EvA.DEwA.D, F_EvA.DEwP.D, F_EvA.DEwC.D, 
                     F_EvA.DAu.D, F_EvA.DAvA.D, F_EvA.DAvP.D, F_EvA.DAvC.D, 
                                  F_EvA.DAwA.D, F_EvA.DAwP.D, F_EvA.DAwC.D, 
                     F_EvA.DIu.D, F_EvA.DIvA.D, F_EvA.DIvP.D, F_EvA.DIvC.D, 
                                  F_EvA.DIwA.D, F_EvA.DIwP.D, F_EvA.DIwC.D, 
                     F_EvA.DHu.D, F_EvA.DHvA.D, F_EvA.DHvP.D, F_EvA.DHvC.D, 
                                  F_EvA.DHwA.D, F_EvA.DHwP.D, F_EvA.DHwC.D)
    
    #EvP.DxE cols
    F_EvP.DEu.D <- F_EvP.DEvA.D <- F_EvP.DEvP.D <- F_EvP.DEvC.D <- 
      F_EvP.DEwA.D <- F_EvP.DEwP.D <- F_EvP.DEwC.D <- beta_vP.D*omega*contact.vP
    #EvP.DxA cols
    F_EvP.DAu.D <- F_EvP.DAvA.D <- F_EvP.DAvP.D <- F_EvP.DAvC.D <- 
      F_EvP.DAwA.D <- F_EvP.DAwP.D <- F_EvP.DAwC.D <- beta_vP.D*omega_a*contact.vP
    #EvP.DxI cols
    F_EvP.DIu.D <- F_EvP.DIvA.D <- F_EvP.DIvP.D <- F_EvP.DIvC.D <- 
      F_EvP.DIwA.D <- F_EvP.DIwP.D <- F_EvP.DIwC.D <- beta_vP.D*contact.vP
    #EvP.DxH cols
    F_EvP.DHu.D <- F_EvP.DHvA.D <- F_EvP.DHvP.D <- F_EvP.DHvC.D <- 
      F_EvP.DHwA.D <- F_EvP.DHwP.D <- F_EvP.DHwC.D <- beta_vP.D*omega_s*contact.vP
    #EvP.D lines
    F_EvP.D <- cbind(F_EvP.DEu.D, F_EvP.DEvA.D, F_EvP.DEvP.D, F_EvP.DEvC.D, 
                                  F_EvP.DEwA.D, F_EvP.DEwP.D, F_EvP.DEwC.D, 
                     F_EvP.DAu.D, F_EvP.DAvA.D, F_EvP.DAvP.D, F_EvP.DAvC.D, 
                                  F_EvP.DAwA.D, F_EvP.DAwP.D, F_EvP.DAwC.D, 
                     F_EvP.DIu.D, F_EvP.DIvA.D, F_EvP.DIvP.D, F_EvP.DIvC.D, 
                                  F_EvP.DIwA.D, F_EvP.DIwP.D, F_EvP.DIwC.D, 
                     F_EvP.DHu.D, F_EvP.DHvA.D, F_EvP.DHvP.D, F_EvP.DHvC.D, 
                                  F_EvP.DHwA.D, F_EvP.DHwP.D, F_EvP.DHwC.D)
    #EvC.DxE cols
    F_EvC.DEu.D <- F_EvC.DEvA.D <- F_EvC.DEvP.D <- F_EvC.DEvC.D <- 
      F_EvC.DEwA.D <- F_EvC.DEwP.D <- F_EvC.DEwC.D <- beta_vC.D*omega*contact.vC
    #EvC.DxA cols
    F_EvC.DAu.D <- F_EvC.DAvA.D <- F_EvC.DAvP.D <- F_EvC.DAvC.D <- 
      F_EvC.DAwA.D <- F_EvC.DAwP.D <- F_EvC.DAwC.D <- beta_vC.D*omega_a*contact.vC
    #EvC.DxI cols
    F_EvC.DIu.D <- F_EvC.DIvA.D <- F_EvC.DIvP.D <- F_EvC.DIvC.D <- 
      F_EvC.DIwA.D <- F_EvC.DIwP.D <- F_EvC.DIwC.D <- beta_vC.D*contact.vC
    #EvC.DxH cols
    F_EvC.DHu.D <- F_EvC.DHvA.D <- F_EvC.DHvP.D <- F_EvC.DHvC.D <- 
      F_EvC.DHwA.D <- F_EvC.DHwP.D <- F_EvC.DHwC.D <- beta_vC.D*omega_s*contact.vC
    #EvC.D lines
    F_EvC.D <- cbind(F_EvC.DEu.D, F_EvC.DEvA.D, F_EvC.DEvP.D, F_EvC.DEvC.D, 
                                  F_EvC.DEwA.D, F_EvC.DEwP.D, F_EvC.DEwC.D, 
                     F_EvC.DAu.D, F_EvC.DAvA.D, F_EvC.DAvP.D, F_EvC.DAvC.D, 
                                  F_EvC.DAwA.D, F_EvC.DAwP.D, F_EvC.DAwC.D, 
                     F_EvC.DIu.D, F_EvC.DIvA.D, F_EvC.DIvP.D, F_EvC.DIvC.D, 
                                  F_EvC.DIwA.D, F_EvC.DIwP.D, F_EvC.DIwC.D, 
                     F_EvC.DHu.D, F_EvC.DHvA.D, F_EvC.DHvP.D, F_EvC.DHvC.D, 
                                  F_EvC.DHwA.D, F_EvC.DHwP.D, F_EvC.DHwC.D)
    
    #F_EwA.DxE cols
    F_EwA.DEu.D <- F_EwA.DEvA.D <- F_EwA.DEvP.D <- F_EwA.DEvC.D <- 
      F_EwA.DEwA.D <- F_EwA.DEwP.D <- F_EwA.DEwC.D <- beta_wA.D*omega*contact.wA
    #F_EwA.DxA cols
    F_EwA.DAu.D <- F_EwA.DAvA.D <- F_EwA.DAvP.D <- F_EwA.DAvC.D <- 
      F_EwA.DAwA.D <- F_EwA.DAwP.D <- F_EwA.DAwC.D <- beta_wA.D*omega_a*contact.wA
    #F_EwA.DxI cols
    F_EwA.DIu.D <- F_EwA.DIvA.D <- F_EwA.DIvP.D <- F_EwA.DIvC.D <- 
      F_EwA.DIwA.D <- F_EwA.DIwP.D <- F_EwA.DIwC.D <- beta_wA.D*contact.wA
    #F_EwA.DxH cols
    F_EwA.DHu.D <- F_EwA.DHvA.D <- F_EwA.DHvP.D <- F_EwA.DHvC.D <- 
      F_EwA.DHwA.D <- F_EwA.DHwP.D <- F_EwA.DHwC.D <- beta_wA.D*omega_s*contact.wA
    #F_EwA.D lines
    F_EwA.D <- cbind(F_EwA.DEu.D, F_EwA.DEvA.D, F_EwA.DEvP.D, F_EwA.DEvC.D, 
                                  F_EwA.DEwA.D, F_EwA.DEwP.D, F_EwA.DEwC.D, 
                     F_EwA.DAu.D, F_EwA.DAvA.D, F_EwA.DAvP.D, F_EwA.DAvC.D, 
                                  F_EwA.DAwA.D, F_EwA.DAwP.D, F_EwA.DAwC.D, 
                     F_EwA.DIu.D, F_EwA.DIvA.D, F_EwA.DIvP.D, F_EwA.DIvC.D, 
                                  F_EwA.DIwA.D, F_EwA.DIwP.D, F_EwA.DIwC.D, 
                     F_EwA.DHu.D, F_EwA.DHvA.D, F_EwA.DHvP.D, F_EwA.DHvC.D, 
                                  F_EwA.DHwA.D, F_EwA.DHwP.D, F_EwA.DHwC.D)
    
    #F_EwP.DxE cols
    F_EwP.DEu.D <- F_EwP.DEvA.D <- F_EwP.DEvP.D <- F_EwP.DEvC.D <- 
      F_EwP.DEwA.D <- F_EwP.DEwP.D <- F_EwP.DEwC.D <- beta_wP.D*omega*contact.wP
    #F_EwP.DxA cols
    F_EwP.DAu.D <- F_EwP.DAvA.D <- F_EwP.DAvP.D <- F_EwP.DAvC.D <- 
      F_EwP.DAwA.D <- F_EwP.DAwP.D <- F_EwP.DAwC.D <- beta_wP.D*omega_a*contact.wP
    #F_EwP.DxI cols
    F_EwP.DIu.D <- F_EwP.DIvA.D <- F_EwP.DIvP.D <- F_EwP.DIvC.D <- 
      F_EwP.DIwA.D <- F_EwP.DIwP.D <- F_EwP.DIwC.D <- beta_wP.D*contact.wP
    #F_EwP.DxH cols
    F_EwP.DHu.D <- F_EwP.DHvA.D <- F_EwP.DHvP.D <- F_EwP.DHvC.D <- 
      F_EwP.DHwA.D <- F_EwP.DHwP.D <- F_EwP.DHwC.D <- beta_wP.D*omega_s*contact.wP
    #F_EwP.D lines
    F_EwP.D <- cbind(F_EwP.DEu.D, F_EwP.DEvA.D, F_EwP.DEvP.D, F_EwP.DEvC.D, 
                                  F_EwP.DEwA.D, F_EwP.DEwP.D, F_EwP.DEwC.D, 
                     F_EwP.DAu.D, F_EwP.DAvA.D, F_EwP.DAvP.D, F_EwP.DAvC.D, 
                                  F_EwP.DAwA.D, F_EwP.DAwP.D, F_EwP.DAwC.D, 
                     F_EwP.DIu.D, F_EwP.DIvA.D, F_EwP.DIvP.D, F_EwP.DIvC.D, 
                                  F_EwP.DIwA.D, F_EwP.DIwP.D, F_EwP.DIwC.D, 
                     F_EwP.DHu.D, F_EwP.DHvA.D, F_EwP.DHvP.D, F_EwP.DHvC.D, 
                                  F_EwP.DHwA.D, F_EwP.DHwP.D, F_EwP.DHwC.D)
    
    #F_EwC.DxE cols
    F_EwC.DEu.D <- F_EwC.DEvA.D <- F_EwC.DEvP.D <- F_EwC.DEvC.D <- 
      F_EwC.DEwA.D <- F_EwC.DEwP.D <- F_EwC.DEwC.D <- beta_wC.D*omega*contact.wC
    #F_EwC.DxA cols
    F_EwC.DAu.D <- F_EwC.DAvA.D <- F_EwC.DAvP.D <- F_EwC.DAvC.D <- 
      F_EwC.DAwA.D <- F_EwC.DAwP.D <- F_EwC.DAwC.D <- beta_wC.D*omega_a*contact.wC
    #F_EwC.DxI cols
    F_EwC.DIu.D <- F_EwC.DIvA.D <- F_EwC.DIvP.D <- F_EwC.DIvC.D <- 
      F_EwC.DIwA.D <- F_EwC.DIwP.D <- F_EwC.DIwC.D <- beta_wC.D*contact.wC
    #F_EwC.DxH cols
    F_EwC.DHu.D <- F_EwC.DHvA.D <- F_EwC.DHvP.D <- F_EwC.DHvC.D <- 
      F_EwC.DHwA.D <- F_EwC.DHwP.D <- F_EwC.DHwC.D <- beta_wC.D*omega_s*contact.wC
    #F_EwC.D lines
    F_EwC.D <- cbind(F_EwC.DEu.D, F_EwC.DEvA.D, F_EwC.DEvP.D, F_EwC.DEvC.D, 
                                  F_EwC.DEwA.D, F_EwC.DEwP.D, F_EwC.DEwC.D, 
                     F_EwC.DAu.D, F_EwC.DAvA.D, F_EwC.DAvP.D, F_EwC.DAvC.D, 
                                  F_EwC.DAwA.D, F_EwC.DAwP.D, F_EwC.DAwC.D, 
                     F_EwC.DIu.D, F_EwC.DIvA.D, F_EwC.DIvP.D, F_EwC.DIvC.D, 
                                  F_EwC.DIwA.D, F_EwC.DIwP.D, F_EwC.DIwC.D, 
                     F_EwC.DHu.D, F_EwC.DHvA.D, F_EwC.DHvP.D, F_EwC.DHvC.D, 
                                  F_EwC.DHwA.D, F_EwC.DHwP.D, F_EwC.DHwC.D)
    #all E's together
    F_E.D <- rbind(F_Eu.D, F_EvA.D, F_EvP.D, F_EvC.D, F_EwA.D, F_EwP.D, F_EwC.D)
    ...
    ################################ OMICRON ###################################
    ############################################################################
    # X_0 = (Eu.O, EvA.O, EvP.O, EvC.O, EwA.O, EwP.O,EwC.O,
    #          Iu.O, IvA.O, IvP.O, IvC.O, IwA.O, IwP.O,IwC.O,
    #          Au.O, AvA.O, AvP.O, AvC.O, AwA.O, AwP.O,AwC.O,
    #          Hu.O, HvA.O, HvP.O, HvC.O, HwA.O, HwP.O,HwC.O)
    # X_1 = (Su, SvA, SvP, SvP, SvC, SwA, SwP, SwC,
    #        Ru.O, RvA.O, RvP.O, RvC.O, RwA.O, RwP.O, RwC.O,
    #        Du.O, DvA.O, DvP.O, DvC.O, DwA.O, DwP.O, DwC.O)
    
    #### F matrix ####
    # EuDxE cols
    F_Eu.OEu.O <- F_Eu.OEvA.O <- F_Eu.OEvP.O <- F_Eu.OEvC.O <- 
      F_Eu.OEwA.O <- F_Eu.OEwP.O <- F_Eu.OEwC.O <-  beta.O*omega*contact.u
    # EuDxA cols
    F_Eu.OAu.O <- F_Eu.OAvA.O <- F_Eu.OAvP.O <- F_Eu.OAvC.O <- 
      F_Eu.OAwA.O <- F_Eu.OAwP.O <- F_Eu.OAwC.O <- beta.O*omega_a*contact.u    
    # EuDxI cols
    F_Eu.OIu.O <- F_Eu.OIvA.O <- F_Eu.OIvP.O <- F_Eu.OIvC.O <- 
      F_Eu.OIwA.O <- F_Eu.OIwP.O <- F_Eu.OIwC.O <- beta.O*contact.u
    # EuDxH cols
    F_Eu.OHu.O <- F_Eu.OHvA.O <- F_Eu.OHvP.O <- F_Eu.OHvC.O <- 
      F_Eu.OHwA.O <- F_Eu.OHwP.O <- F_Eu.OHwC.O <- beta.O*omega_s*contact.u
    # EuD lines
    F_Eu.O <- cbind(F_Eu.OEu.O, F_Eu.OEvA.O, F_Eu.OEvP.O, F_Eu.OEvC.O, 
                    F_Eu.OEwA.O, F_Eu.OEwP.O, F_Eu.OEwC.O,
                    F_Eu.OAu.O, F_Eu.OAvA.O, F_Eu.OAvP.O, F_Eu.OAvC.O, 
                    F_Eu.OAwA.O, F_Eu.OAwP.O, F_Eu.OAwC.O, 
                    F_Eu.OIu.O, F_Eu.OIvA.O, F_Eu.OIvP.O, F_Eu.OIvC.O, 
                    F_Eu.OIwA.O, F_Eu.OIwP.O, F_Eu.OIwC.O, 
                    F_Eu.OHu.O, F_Eu.OHvA.O, F_Eu.OHvP.O, F_Eu.OHvC.O,
                    F_Eu.OHwA.O, F_Eu.OHwP.O, F_Eu.OHwC.O)
    
    # EvA.OxE cols
    F_EvA.OEu.O <- F_EvA.OEvA.O <- F_EvA.OEvP.O <- F_EvA.OEvC.O <- 
      F_EvA.OEwA.O <- F_EvA.OEwP.O <- F_EvA.OEwC.O <- beta_vA.O*omega*contact.vA
    #EvA.OxA cols    
    F_EvA.OAu.O <- F_EvA.OAvA.O <- F_EvA.OAvP.O <- F_EvA.OAvC.O <- 
      F_EvA.OAwA.O <- F_EvA.OAwP.O <- F_EvA.OAwC.O <- beta_vA.O*omega_a*contact.vA
    # EvA.OxI cols
    F_EvA.OIu.O <- F_EvA.OIvA.O <- F_EvA.OIvP.O <- F_EvA.OIvC.O <- 
      F_EvA.OIwA.O <- F_EvA.OIwP.O <- F_EvA.OIwC.O <- beta_vA.O*contact.vA
    #EvA.OxH cols
    F_EvA.OHu.O <- F_EvA.OHvA.O <- F_EvA.OHvP.O <- F_EvA.OHvC.O <- 
      F_EvA.OHwA.O <- F_EvA.OHwP.O <- F_EvA.OHwC.O <- beta_vA.O*omega_s*contact.vA
    #F_EvA.O lines
    F_EvA.O <- cbind(F_EvA.OEu.O, F_EvA.OEvA.O, F_EvA.OEvP.O, F_EvA.OEvC.O, 
                     F_EvA.OEwA.O, F_EvA.OEwP.O, F_EvA.OEwC.O, 
                     F_EvA.OAu.O, F_EvA.OAvA.O, F_EvA.OAvP.O, F_EvA.OAvC.O, 
                     F_EvA.OAwA.O, F_EvA.OAwP.O, F_EvA.OAwC.O, 
                     F_EvA.OIu.O, F_EvA.OIvA.O, F_EvA.OIvP.O, F_EvA.OIvC.O, 
                     F_EvA.OIwA.O, F_EvA.OIwP.O, F_EvA.OIwC.O, 
                     F_EvA.OHu.O, F_EvA.OHvA.O, F_EvA.OHvP.O, F_EvA.OHvC.O, 
                     F_EvA.OHwA.O, F_EvA.OHwP.O, F_EvA.OHwC.O)
    
    #EvP.OxE cols
    F_EvP.OEu.O <- F_EvP.OEvA.O <- F_EvP.OEvP.O <- F_EvP.OEvC.O <- 
      F_EvP.OEwA.O <- F_EvP.OEwP.O <- F_EvP.OEwC.O <- beta_vP.O*omega*contact.vP
    #EvP.OxA cols
    F_EvP.OAu.O <- F_EvP.OAvA.O <- F_EvP.OAvP.O <- F_EvP.OAvC.O <- 
      F_EvP.OAwA.O <- F_EvP.OAwP.O <- F_EvP.OAwC.O <- beta_vP.O*omega_a*contact.vP
    #EvP.OxI cols
    F_EvP.OIu.O <- F_EvP.OIvA.O <- F_EvP.OIvP.O <- F_EvP.OIvC.O <- 
      F_EvP.OIwA.O <- F_EvP.OIwP.O <- F_EvP.OIwC.O <- beta_vP.O*contact.vP
    #EvP.OxH cols
    F_EvP.OHu.O <- F_EvP.OHvA.O <- F_EvP.OHvP.O <- F_EvP.OHvC.O <- 
      F_EvP.OHwA.O <- F_EvP.OHwP.O <- F_EvP.OHwC.O <- beta_vP.O*omega_s*contact.vP
    #EvP.O lines
    F_EvP.O <- cbind(F_EvP.OEu.O, F_EvP.OEvA.O, F_EvP.OEvP.O, F_EvP.OEvC.O, 
                     F_EvP.OEwA.O, F_EvP.OEwP.O, F_EvP.OEwC.O, 
                     F_EvP.OAu.O, F_EvP.OAvA.O, F_EvP.OAvP.O, F_EvP.OAvC.O, 
                     F_EvP.OAwA.O, F_EvP.OAwP.O, F_EvP.OAwC.O, 
                     F_EvP.OIu.O, F_EvP.OIvA.O, F_EvP.OIvP.O, F_EvP.OIvC.O, 
                     F_EvP.OIwA.O, F_EvP.OIwP.O, F_EvP.OIwC.O, 
                     F_EvP.OHu.O, F_EvP.OHvA.O, F_EvP.OHvP.O, F_EvP.OHvC.O, 
                     F_EvP.OHwA.O, F_EvP.OHwP.O, F_EvP.OHwC.O)
    #EvC.OxE cols
    F_EvC.OEu.O <- F_EvC.OEvA.O <- F_EvC.OEvP.O <- F_EvC.OEvC.O <- 
      F_EvC.OEwA.O <- F_EvC.OEwP.O <- F_EvC.OEwC.O <- beta_vC.O*omega*contact.vC
    #EvC.OxA cols
    F_EvC.OAu.O <- F_EvC.OAvA.O <- F_EvC.OAvP.O <- F_EvC.OAvC.O <- 
      F_EvC.OAwA.O <- F_EvC.OAwP.O <- F_EvC.OAwC.O <- beta_vC.O*omega_a*contact.vC
    #EvC.OxI cols
    F_EvC.OIu.O <- F_EvC.OIvA.O <- F_EvC.OIvP.O <- F_EvC.OIvC.O <- 
      F_EvC.OIwA.O <- F_EvC.OIwP.O <- F_EvC.OIwC.O <- beta_vC.O*contact.vC
    #EvC.OxH cols
    F_EvC.OHu.O <- F_EvC.OHvA.O <- F_EvC.OHvP.O <- F_EvC.OHvC.O <- 
      F_EvC.OHwA.O <- F_EvC.OHwP.O <- F_EvC.OHwC.O <- beta_vC.O*omega_s*contact.vC
    #EvC.O lines
    F_EvC.O <- cbind(F_EvC.OEu.O, F_EvC.OEvA.O, F_EvC.OEvP.O, F_EvC.OEvC.O, 
                     F_EvC.OEwA.O, F_EvC.OEwP.O, F_EvC.OEwC.O, 
                     F_EvC.OAu.O, F_EvC.OAvA.O, F_EvC.OAvP.O, F_EvC.OAvC.O, 
                     F_EvC.OAwA.O, F_EvC.OAwP.O, F_EvC.OAwC.O, 
                     F_EvC.OIu.O, F_EvC.OIvA.O, F_EvC.OIvP.O, F_EvC.OIvC.O, 
                     F_EvC.OIwA.O, F_EvC.OIwP.O, F_EvC.OIwC.O, 
                     F_EvC.OHu.O, F_EvC.OHvA.O, F_EvC.OHvP.O, F_EvC.OHvC.O, 
                     F_EvC.OHwA.O, F_EvC.OHwP.O, F_EvC.OHwC.O)
    
    #F_EwA.OxE cols
    F_EwA.OEu.O <- F_EwA.OEvA.O <- F_EwA.OEvP.O <- F_EwA.OEvC.O <- 
      F_EwA.OEwA.O <- F_EwA.OEwP.O <- F_EwA.OEwC.O <- beta_wA.O*omega*contact.wA
    #F_EwA.OxA cols
    F_EwA.OAu.O <- F_EwA.OAvA.O <- F_EwA.OAvP.O <- F_EwA.OAvC.O <- 
      F_EwA.OAwA.O <- F_EwA.OAwP.O <- F_EwA.OAwC.O <- beta_wA.O*omega_a*contact.wA
    #F_EwA.OxI cols
    F_EwA.OIu.O <- F_EwA.OIvA.O <- F_EwA.OIvP.O <- F_EwA.OIvC.O <- 
      F_EwA.OIwA.O <- F_EwA.OIwP.O <- F_EwA.OIwC.O <- beta_wA.O*contact.wA
    #F_EwA.OxH cols
    F_EwA.OHu.O <- F_EwA.OHvA.O <- F_EwA.OHvP.O <- F_EwA.OHvC.O <- 
      F_EwA.OHwA.O <- F_EwA.OHwP.O <- F_EwA.OHwC.O <- beta_wA.O*omega_s*contact.wA
    #F_EwA.O lines
    F_EwA.O <- cbind(F_EwA.OEu.O, F_EwA.OEvA.O, F_EwA.OEvP.O, F_EwA.OEvC.O, 
                     F_EwA.OEwA.O, F_EwA.OEwP.O, F_EwA.OEwC.O, 
                     F_EwA.OAu.O, F_EwA.OAvA.O, F_EwA.OAvP.O, F_EwA.OAvC.O, 
                     F_EwA.OAwA.O, F_EwA.OAwP.O, F_EwA.OAwC.O, 
                     F_EwA.OIu.O, F_EwA.OIvA.O, F_EwA.OIvP.O, F_EwA.OIvC.O, 
                     F_EwA.OIwA.O, F_EwA.OIwP.O, F_EwA.OIwC.O, 
                     F_EwA.OHu.O, F_EwA.OHvA.O, F_EwA.OHvP.O, F_EwA.OHvC.O, 
                     F_EwA.OHwA.O, F_EwA.OHwP.O, F_EwA.OHwC.O)
    
    #F_EwP.OxE cols
    F_EwP.OEu.O <- F_EwP.OEvA.O <- F_EwP.OEvP.O <- F_EwP.OEvC.O <- 
      F_EwP.OEwA.O <- F_EwP.OEwP.O <- F_EwP.OEwC.O <- beta_wP.O*omega*contact.wP
    #F_EwP.OxA cols
    F_EwP.OAu.O <- F_EwP.OAvA.O <- F_EwP.OAvP.O <- F_EwP.OAvC.O <- 
      F_EwP.OAwA.O <- F_EwP.OAwP.O <- F_EwP.OAwC.O <- beta_wP.O*omega_a*contact.wP
    #F_EwP.OxI cols
    F_EwP.OIu.O <- F_EwP.OIvA.O <- F_EwP.OIvP.O <- F_EwP.OIvC.O <- 
      F_EwP.OIwA.O <- F_EwP.OIwP.O <- F_EwP.OIwC.O <- beta_wP.O*contact.wP
    #F_EwP.OxH cols
    F_EwP.OHu.O <- F_EwP.OHvA.O <- F_EwP.OHvP.O <- F_EwP.OHvC.O <- 
      F_EwP.OHwA.O <- F_EwP.OHwP.O <- F_EwP.OHwC.O <- beta_wP.O*omega_s*contact.wP
    #F_EwP.O lines
    F_EwP.O <- cbind(F_EwP.OEu.O, F_EwP.OEvA.O, F_EwP.OEvP.O, F_EwP.OEvC.O, 
                     F_EwP.OEwA.O, F_EwP.OEwP.O, F_EwP.OEwC.O, 
                     F_EwP.OAu.O, F_EwP.OAvA.O, F_EwP.OAvP.O, F_EwP.OAvC.O, 
                     F_EwP.OAwA.O, F_EwP.OAwP.O, F_EwP.OAwC.O, 
                     F_EwP.OIu.O, F_EwP.OIvA.O, F_EwP.OIvP.O, F_EwP.OIvC.O, 
                     F_EwP.OIwA.O, F_EwP.OIwP.O, F_EwP.OIwC.O, 
                     F_EwP.OHu.O, F_EwP.OHvA.O, F_EwP.OHvP.O, F_EwP.OHvC.O, 
                     F_EwP.OHwA.O, F_EwP.OHwP.O, F_EwP.OHwC.O)
    
    #F_EwC.OxE cols
    F_EwC.OEu.O <- F_EwC.OEvA.O <- F_EwC.OEvP.O <- F_EwC.OEvC.O <- 
      F_EwC.OEwA.O <- F_EwC.OEwP.O <- F_EwC.OEwC.O <- beta_wC.O*omega*contact.wC
    #F_EwC.OxA cols
    F_EwC.OAu.O <- F_EwC.OAvA.O <- F_EwC.OAvP.O <- F_EwC.OAvC.O <- 
      F_EwC.OAwA.O <- F_EwC.OAwP.O <- F_EwC.OAwC.O <- beta_wC.O*omega_a*contact.wC
    #F_EwC.OxI cols
    F_EwC.OIu.O <- F_EwC.OIvA.O <- F_EwC.OIvP.O <- F_EwC.OIvC.O <- 
      F_EwC.OIwA.O <- F_EwC.OIwP.O <- F_EwC.OIwC.O <- beta_wC.O*contact.wC
    #F_EwC.OxH cols
    F_EwC.OHu.O <- F_EwC.OHvA.O <- F_EwC.OHvP.O <- F_EwC.OHvC.O <- 
      F_EwC.OHwA.O <- F_EwC.OHwP.O <- F_EwC.OHwC.O <- beta_wC.O*omega_s*contact.wC
    #F_EwC.O lines
    F_EwC.O <- cbind(F_EwC.OEu.O, F_EwC.OEvA.O, F_EwC.OEvP.O, F_EwC.OEvC.O, 
                     F_EwC.OEwA.O, F_EwC.OEwP.O, F_EwC.OEwC.O, 
                     F_EwC.OAu.O, F_EwC.OAvA.O, F_EwC.OAvP.O, F_EwC.OAvC.O, 
                     F_EwC.OAwA.O, F_EwC.OAwP.O, F_EwC.OAwC.O, 
                     F_EwC.OIu.O, F_EwC.OIvA.O, F_EwC.OIvP.O, F_EwC.OIvC.O, 
                     F_EwC.OIwA.O, F_EwC.OIwP.O, F_EwC.OIwC.O, 
                     F_EwC.OHu.O, F_EwC.OHvA.O, F_EwC.OHvP.O, F_EwC.OHvC.O, 
                     F_EwC.OHwA.O, F_EwC.OHwP.O, F_EwC.OHwC.O)
    #all E's together
    F_E.O <- rbind(F_Eu.O, F_EvA.O, F_EvP.O, F_EvC.O, F_EwA.O, F_EwP.O, F_EwC.O)
    # other lines are zero
