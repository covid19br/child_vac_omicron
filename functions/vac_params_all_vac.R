...
VAX1.PARS <- with(parameters,OBSERVED.EFFICACY.TO.PARAMETERS(ihr,ihfr,asymp,
                                                             vax1.beta.effic.P,vax1.hosp.effic.P,
                                                             vax1.death.effic.P,vax1.symp.effic.P))
VAX2.PARS <- with(parameters,OBSERVED.EFFICACY.TO.PARAMETERS(ihr,ihfr,asymp,
...
parameters$beta_vP <- (1- VAX1.EFFIC.BETA)*parameters$beta
# Fraction of asymptomatic cases in total cases (pclin) \alpha_v
parameters$asymp_vP <- 1 - (1 - parameters$asymp) * (1-VAX1.EFFIC.CLIN)
# Fraction of severe cases in symptomatic cases (IHR) \sigma_v
parameters$ihr_vP <- (1-VAX1.EFFIC.SEVERE)*parameters$ihr
# Fraction of deaths in severe cases/hospitalizations of vaccinated population (IHFR) \mu_v
parameters$ihfr_vP <- (1-VAX1.EFFIC.DEATH)*parameters$ihfr
...
##############################
#### Classification of cases related to the severity of cases of once-vaccinated individuals
parameters$beta_wP <- (1- VAX2.EFFIC.BETA)*parameters$beta
# Fraction of asymptomatic cases in total cases (pclin) \alpha_v
parameters$asymp_wP <- 1 - (1 - parameters$asymp) * (1-VAX2.EFFIC.CLIN)
# Fraction of severe cases in symptomatic cases (IHR) \sigma_v
parameters$ihr_wP <- (1-VAX2.EFFIC.SEVERE)*parameters$ihr
# Fraction of deaths in severe cases/hospitalizations of vaccinated population (IHFR) \mu_v
parameters$ihfr_wP <- (1-VAX2.EFFIC.DEATH)*parameters$ihfr
...
#### Classification of cases related to the severity of cases of once-vaccinated individuals
parameters$beta_vA <- (1- VAX1.EFFIC.BETA)*parameters$beta
# Fraction of asymptomatic cases in total cases (pclin) \alpha_v
parameters$asymp_vA <- 1 - (1 - parameters$asymp) * (1-VAX1.EFFIC.CLIN)
# Fraction of severe cases in symptomatic cases (IHR) \sigma_v
parameters$ihr_vA <- (1-VAX1.EFFIC.SEVERE)*parameters$ihr
# Fraction of deaths in severe cases/hospitalizations of vaccinated population (IHFR) \mu_v
parameters$ihfr_vA <- (1-VAX1.EFFIC.DEATH)*parameters$ihfr
...
##############################
#### Classification of cases related to the severity of cases of once-vaccinated individuals
parameters$beta_wA <- (1- VAX2.EFFIC.BETA)*parameters$beta
# Fraction of asymptomatic cases in total cases (pclin) \alpha_v
parameters$asymp_wA <- 1 - (1 - parameters$asymp) * (1-VAX2.EFFIC.CLIN)
# Fraction of severe cases in symptomatic cases (IHR) \sigma_v
parameters$ihr_wA <- (1-VAX2.EFFIC.SEVERE)*parameters$ihr
# Fraction of deaths in severe cases/hospitalizations of vaccinated population (IHFR) \mu_v
parameters$ihfr_wA <- (1-VAX2.EFFIC.DEATH)*parameters$ihfr
...
#### Classification of cases related to the severity of cases of once-vaccinated individuals
parameters$beta_vC <- (1- VAX1.EFFIC.BETA)*parameters$beta
# Fraction of asymptomatic cases in total cases (pclin) \alpha_v
parameters$asymp_vC <- 1 - (1 - parameters$asymp) * (1-VAX1.EFFIC.CLIN)
# Fraction of severe cases in symptomatic cases (IHR) \sigma_v
parameters$ihr_vC <- (1-VAX1.EFFIC.SEVERE)*parameters$ihr
# Fraction of deaths in severe cases/hospitalizations of vaccinated population (IHFR) \mu_v
parameters$ihfr_vC <- (1-VAX1.EFFIC.DEATH)*parameters$ihfr
...
##############################
#### Classification of cases related to the severity of cases of once-vaccinated individuals
parameters$beta_wC <- (1- VAX2.EFFIC.BETA)*parameters$beta
# Fraction of asymptomatic cases in total cases (pclin) \alpha_v
parameters$asymp_wC <- 1 - (1 - parameters$asymp) * (1-VAX2.EFFIC.CLIN)
# Fraction of severe cases in symptomatic cases (IHR) \sigma_v
parameters$ihr_wC <- (1-VAX2.EFFIC.SEVERE)*parameters$ihr
# Fraction of deaths in severe cases/hospitalizations of vaccinated population (IHFR) \mu_v
parameters$ihfr_wC <- (1-VAX2.EFFIC.DEATH)*parameters$ihfr
######mexendo com historico
